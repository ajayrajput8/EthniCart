...
export default function AdminLayout() {
  ...
  // =========================================================
  // PRODUCTS - NOW USING SHARED LOCAL STORAGE
  // =========================================================
  ...
  const uploadImageToCloudinary = async (file) => {
    if (CLOUDINARY_CLOUD_NAME === "your_cloud_name") {
      console.warn(
        "Cloudinary not configured. Returning local object URL for demo."
      );
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-8 overflow-y-auto">
        <header className="flex justify-between items-center pb-6 border-b border-gray-200 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="/"
              className="w-9 h-9 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-xs shadow-sm"
            >
              Home
            </a>
          </div>
